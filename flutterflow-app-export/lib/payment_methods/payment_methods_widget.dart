                              ...
                              children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Payment methods registered with Stripe.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
                                              ),
                                ...
                                Container(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: GetCustomersPaymentMethodsCall.call(
                                      bearerToken: functions.supabaseJwtToken(),
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      final dataTableGetCustomersPaymentMethodsResponse =
                                          snapshot.data!;
                                      return Builder(
                                        builder: (context) {
                                          final paymentMethods =
                                              (GetCustomersPaymentMethodsCall
                                                          .allRecords(
                                                        dataTableGetCustomersPaymentMethodsResponse
                                                            .jsonBody,
                                                      )?.toList() ??
                                                      [])
                                                  .take(5)
                                          ...
                                          return DataTable2(
                                            ...
                                            rows: (paymentMethods as Iterable)
                                                .mapIndexed((paymentMethodsIndex,
                                                        paymentMethodsItem) =>
                                                    [
                                                      Text(
                                                        getJsonField(
