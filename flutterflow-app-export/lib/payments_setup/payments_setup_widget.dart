...
import 'payments_setup_model.dart';
export 'payments_setup_model.dart';

class PaymentsSetupWidget extends StatefulWidget {
  const PaymentsSetupWidget({Key? key}) : super(key: key);

  @override
  _PaymentsSetupWidgetState createState() => _PaymentsSetupWidgetState();
}

class _PaymentsSetupWidgetState extends State<PaymentsSetupWidget> {
  late PaymentsSetupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentsSetupModel());
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'Enter payment details for billing.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
                                              ),
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: custom_widgets
                                        .StripeSetupPaymentsWidget(
                                      width: MediaQuery.of(context).size.width *
                                          1.0,
                                      height:
                                          MediaQuery.of(context).size.height *
                                              1.0,
                                      jwtToken: functions.supabaseJwtToken(),
                                    ),
                                  ),
                                ),
                                if (responsiveVisibility(
