...
class ConfirmDetailsConfirmationModalWidget extends StatefulWidget {
  const ConfirmDetailsConfirmationModalWidget({super.key});

  @override
  State<ConfirmDetailsConfirmationModalWidget> createState() =>
      _ConfirmDetailsConfirmationModalWidgetState();
}

class _ConfirmDetailsConfirmationModalWidgetState
    extends State<ConfirmDetailsConfirmationModalWidget> {
  late ConfirmDetailsConfirmationModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmDetailsConfirmationModalModel());
                            ...
                            onPressed: (FFAppState().impersonationToken !=
                                ...
                                : () async {
                                    ...
                                    _model.customerDetailsConfirmedResponse =
                                        await CustomerDetailsConfirmedCall.call(
