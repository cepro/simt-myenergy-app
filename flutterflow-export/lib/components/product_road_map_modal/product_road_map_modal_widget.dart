...
class ProductRoadMapModalWidget extends StatefulWidget {
  const ProductRoadMapModalWidget({super.key});

  @override
  State<ProductRoadMapModalWidget> createState() =>
      _ProductRoadMapModalWidgetState();
}

class _ProductRoadMapModalWidgetState extends State<ProductRoadMapModalWidget> {
  late ProductRoadMapModalModel _model;
