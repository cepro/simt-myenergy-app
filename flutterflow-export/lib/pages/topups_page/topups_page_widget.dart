...
import 'topups_page_model.dart';
export 'topups_page_model.dart';
...
class _TopupsPageWidgetState extends State<TopupsPageWidget> {
  late TopupsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupsPageModel());
